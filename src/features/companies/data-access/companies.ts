...
export const companies: Company[] = [
  {
    ...
    stage: 'Orbital',
    founded: '2018',
    summary: 'Building a family of on-demand small-satellite launch vehicles with carbon-composite structures and 3D-printed engines.',
  ...
  },
  {
    ...
    stage: 'Commercial',
    founded: '2019',
    summary: 'Operating hyperspectral satellites and the Aurora platform to reveal environmental and industrial signals invisible to conventional imagery.',
  ...
  },
  {
    ...
    stage: 'Flight-proven',
    founded: '2017',
    summary: 'Developing customizable small-satellite launch vehicles powered by semi-cryogenic, single-piece 3D-printed engines.',
  ...
  },
  {
    ...
    stage: 'Scaling',
    founded: '2015',
    summary: 'Designing electric and green propulsion systems plus an orbital transfer vehicle for satellites across multiple orbit classes.',
  ...
  },
  {
    ...
    stage: 'Commercial',
    founded: '2012',
    summary: 'Providing spacecraft platforms, launch integration and ground infrastructure as one integrated space-engineering stack.',
  ...
  },
  {
    ...
    stage: 'Pre-launch',
    founded: '2021',
    summary: 'Combining radar and optical sensors on one satellite for aligned, analysis-ready imagery in darkness and cloud cover.',
  ...
  },
  {
    ...
    stage: 'Flight-proven',
    founded: '2017',
    summary: 'Building hydrogen-peroxide green thrusters and in-space refuelling kit so satellites can manoeuvre without hydrazine.',
  ...
  },
  {
    ...
    stage: 'Scaling',
    founded: '2016',
    summary: 'Designing propulsion, avionics, and guidance hardware that other launch vehicles and spacecraft depend on.',
  ...
  },
  {
    ...
    stage: 'Commercial',
    founded: '2019',
    summary: 'An Indo-German joint venture running a factory for 50–200 kg small-satellite buses at a rate of two vehicles a week.',
  ...
  },
  {
    ...
    stage: 'Flight-proven',
    founded: '2022',
    summary: 'Building software-defined nano and micro satellites for defence and commercial hosted-payload missions.',
  ...
  },
  {
    ...
    stage: 'Scaling',
    founded: '2020',
    summary: 'Building space-based sensors and a tracking network so operators can see objects and threats in orbit.',
  ...
  },
  {
    ...
    stage: 'Commercial',
    founded: '2017',
    summary: 'Turning satellite and aerial imagery into decisions for agriculture, banking, infrastructure, and climate risk.',
  ...
  },
  {
    ...
    stage: 'Flight-proven',
    founded: '2020',
    summary: 'Putting AI and edge computers on satellites so insights come down instead of raw imagery.',
  ...
  },
  {
    ...
    stage: 'Pre-launch',
    founded: '2023',
    summary: 'Combining SAR and AIS on one constellation for all-weather, persistent ocean surveillance.',
  ...
  },
  {
    ...
    stage: 'Flight-proven',
    founded: '2021',
    summary: 'Developing docking ports and refuelling hardware so satellites can be topped up and serviced in orbit.',
